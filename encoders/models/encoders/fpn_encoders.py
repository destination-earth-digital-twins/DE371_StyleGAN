...
from encoders.models.encoders.map2style import GradualStyleBlock
...
class GradualStyleEncoder(Module):
    ...
    """
    def __init__(self, num_layers, mode='ir', n_styles=18, config=None):
        ...
        self.input_layer = Sequential(Conv2d(config.input_nc, 64, (3, 3), 1, 1, bias=False),
                                      BatchNorm2d(64),
                                      PReLU(64))
        modules = []
        for block in blocks:
...
class ResNetGradualStyleEncoder(Module):
    ...
    """
    def __init__(self, n_styles=18, config=None):

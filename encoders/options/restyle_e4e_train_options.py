from encoders.options.e4e_train_options import e4eTrainOptions

class Restylee4eTrainOptions(e4eTrainOptions):

    def __init__(self):
        super(Restylee4eTrainOptions, self).__init__()

    def initialize(self):
        super(Restylee4eTrainOptions, self).initialize()

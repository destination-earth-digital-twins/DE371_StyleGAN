...
class RestylepSpTrainOptions(TrainOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--l2_lambda_on_fake_latent', default=0, type=float,help='L2 loss factor on fake features')
        self.parser.add_argument('--perceptual_lambda_on_fake_samples', default=0, type=float,help='Perceptual Loss Factor on fake samples')
        ...
        self.parser.add_argument('--w_norm_lambda', default=0, type=float,help='L2 loss factor on fake features')

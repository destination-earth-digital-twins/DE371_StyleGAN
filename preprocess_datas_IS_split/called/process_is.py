...
def importance_sampling(parameters, dirs, gridshape, variable, args):
    ...
    s_gigafile = {gigafile for gigafile in os.scandir(data_dir) if gigafile.name != "labels.csv" and "~" not in gigafile.name and gigafile.name not in ["area_proportions.npy", "area_proportions.png", "labels.csv","datasaved5_0.001_500_prem","data_for_importance_sampling_area_proportionslog10.png"]}

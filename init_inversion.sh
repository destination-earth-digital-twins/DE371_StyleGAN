...
apptainer exec --nv /project/scratch/p200177/DE_371/resources/apptainer_container/container.sif python3 main_inversion.py \
        ...
        --output_dir='/project/scratch/p200177/DE_371/victorsanchez/results/member_inversion/test_latent_trajectory_during_optim/inversion/' \
        --pack_dir='' \
        --device='cuda' \
        --lambda_pixel=0 \
        --lambda_vgg=1e5 \
        ...
        --invstep=2000 \
        --resize_vgg_input=1 \
        --inv_checkpoints='[0,125,250,325,500,625,750,875,1000,1125,1250,1325,1500,1625,1750,1875,2000]' \

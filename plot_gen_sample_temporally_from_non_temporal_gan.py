...
if __name__=="__main__" :
    ...
    parser.add_argument('--output_dir',type = str, default ='/project/scratch/p200177/DE_371/victorsanchez/results/perturbation/coherence_temporelle_gan_classique/plots_ter/')
    ...
    for date_ in list_dates:
        ...
        for group_id in range(len(member_id_list)-2):
            ...
            if display_AROME:
                fig0, ax0 = plt.subplots(nrows=groud_length, ncols=14, figsize=(200,50))
                fig1, ax1 = plt.subplots(nrows=groud_length, ncols=14, figsize=(200,50))
                fig2, ax2 = plt.subplots(nrows=groud_length, ncols=14, figsize=(200,50))
            fig0gen, ax0gen = plt.subplots(nrows=groud_length, ncols=14, figsize=(200,50))
            fig1gen, ax1gen = plt.subplots(nrows=groud_length, ncols=14, figsize=(200,50))
            fig2gen, ax2gen = plt.subplots(nrows=groud_length, ncols=14, figsize=(200,50))
            ...
            for offset in range(7):
                ...
                fig0gen.savefig(params.output_dir+f'gen_samples_u_{date_}{label_perturbation}_{Nb_member}_{start_member_id}_{end_member_id}_{offset}.png')
                fig1gen.savefig(params.output_dir+f'gen_samples_v_{date_}{label_perturbation}_{Nb_member}_{start_member_id}_{end_member_id}_{offset}.png')
                fig2gen.savefig(params.output_dir+f'gen_samples_t2m_{date_}{label_perturbation}_{Nb_member}_{start_member_id}_{end_member_id}_{offset}.png')

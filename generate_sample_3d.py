...
from gan.model.stylegan2_3d import Generator3D, Discriminator3D
        ...
        for t in trange(args.n_batches) :
            ...
            if args.multi_timestep_mode :
                ...
                if args.stack_sample_along_time_and_variable:
                    ...
                    b, c, nb_timesteps_per_variable, h, w = x_sample.shape
                    x_sample=x_sample.detach().cpu().transpose(1,2).numpy()

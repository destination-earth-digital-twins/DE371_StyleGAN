''' From https://github.com/InterDigitalInc/FeatureStyleEncoder/blob/main/nets/feature_style_encoder.py '''
...
from restyle_encoder.models.feature_style_encoder.iresnet import iresnet50

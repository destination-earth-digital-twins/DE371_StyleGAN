...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_type', default='arome_encode', type=str,
                                 help='Type of dataset/experiment to run')
        self.parser.add_argument('--encoder_type', default='ResNetBackboneEncoder', type=str,
        ...
        self.parser.add_argument('--output_size', default=128, type=int,
                                 help='Output size of generator')
        self.parser.add_argument('--n_vars', default=3, type=int,
                                 help='Number of variables as channels')
        ...
        # optimizers
        self.parser.add_argument('--learning_rate', default=0.001, type=float,
        ...
        self.parser.add_argument('--weight_decay', default = 0.0, type =float,
                                 help = 'Adding weight decay to the encoder')
        ...
        self.parser.add_argument('--scat_lambda', default=0, type=float,
                                 help='Scattering loss multiplier factor')
        self.parser.add_argument('--swd_lambda', default=0, type=float,
                                 help='Sliced Wasserstein Distance loss multiplier factor')
        ...
        self.parser.add_argument('--resume_step', default=0, type=int,
                                 help='step number to resume from')

        # intervals for logging, validation, and saving
        self.parser.add_argument('--max_steps', default=50000, type=int,
...
def createNamesFromLosses(opts) :
    
    name ='loss_train'
    
    opts_dict = vars(opts)
    
    for arg, value in opts_dict.items() :

...
path = "/scratch/mrmn/poulainauzeaul/Exp_StyleGAN/Set_1/"
multip = True # set to true if you want to do multiprocessing 
              # (test several times on x samples and compute mean + std for several lat_dim)
test_oscil = True

data_dir = "/scratch/mrmn/poulainauzeaul/Exp_StyleGAN/IS_1_1.0_0_0_0_0_0_256_done_with_8_var/"
metrics_names = ["multivar", "pw_W1", "W1_random", "W1_Center", "SWD_metric_torch", "quant_metric",
...
if not multip:
    i = 64
    latent_dim = i
    output_dir = path + f"stylegan2_stylegan_lat-dim_{i}_bs_16_0.002_0.002_ch-mul_2/Instance_1"
    ...
    def multip_plotter(lat_dim):
        output_dir = path + f"stylegan2_stylegan_lat-dim_{lat_dim}_bs_16_0.002_0.002_ch-mul_2/Instance_1"

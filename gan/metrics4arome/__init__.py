...
distance_metrics = {'Orography_RMSE', 'W1_Center', "W1_Center_NUMPY", "W1_random",
                    ...
                    "spectral_dist","spectral_dist_rr", "spectral_dist_torch_rr", "spectral_dist_torch_rr_u_v", "spectral_dist_torch_rr_t2m", "spectral_dist_torch_rr_u_v_t2m"}
...
spectral_dist_rr = metric2D('Power Spectral Density RMSE  ',\
                  Spectral.PSD_compare, vars_rr, names = ['PSDrr'])
spectral_dist_torch_rr = metric2D('Power Spectral Density RMSE  ',\
                  Spectral.PSD_compare_torch, vars_rr, names = ['PSDrr'])
...
spectral_dist_torch_rr_u_v = metric2D('Power Spectral Density RMSE  ',\
                  Spectral.PSD_compare_torch, vars_rr_u_v, names = ['PSDrr','PSDu','PSDv'])
spectral_dist_torch_rr_t2m = metric2D('Power Spectral Density RMSE  ',\
                  Spectral.PSD_compare_torch, vars_rr_t2m, names = ['PSDrr','PSDt2m'])
spectral_dist_torch_rr_u_v_t2m = metric2D('Power Spectral Density RMSE  ',\
                  Spectral.PSD_compare_torch, vars_rr_u_v_t2m, names = ['PSDrr','PDSu','PSDv','PSDt2m'])

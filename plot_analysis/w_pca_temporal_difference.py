...
if __name__=="__main__" :
    ...
    parser.add_argument('--output_dir',      type=str, default='/project/scratch/p200177/DE_371/victorsanchez/results/pca/temporal_comparison')
    parser.add_argument('--w_inversion_dir1', type=str, default='/project/home/p200177/DE_371/experiments_WP1/inversion_process_analysis/final_inversion_on_test_set/optim_method/perceptual_exp45/inversion')
    parser.add_argument('--inversion_step_1',  type=str, default="1000")
    parser.add_argument('--w_inversion_dir2', type=str, default='/project/home/p200177/DE_371/experiments_WP1/inversion_process_analysis/final_inversion_on_test_set/optim_method/perceptual_exp45/inversion') 
    parser.add_argument('--inversion_step_2',  type=str, default="1000")
    ...
    parser.add_argument('--case',           type=str, default="2021-07-28", help="specific inversion case to consider") # %Y-%m-%d_lt
    ...
    for leadtimes in range(1,44):
        ## From Gan Inversion
        w_inv1 = np.load(f"{args.w_inversion_dir1}/w_{args.case}_{leadtimes}_{args.inversion_step_1}.npy")[0]
        print('shape w_inv1 : ', w_inv1.shape)
        w_inv2 = np.load(f"{args.w_inversion_dir2}/w_{args.case}_{leadtimes+1}_{args.inversion_step_2}.npy")[0]
        ...
        figname = f"{args.output_dir}/projected_pca_2d_w_scatter_{args.case}_{leadtimes}.png"
        ...
        figname = f"{args.output_dir}/projected_pca_3d_w_scatter_{args.case}_{leadtimes}.png"
        fig.savefig(figname, dpi=100)
        ...
        ax.grid(True)
        figname = f"{args.output_dir}/scree_plot_w_scatter_{args.case}_{leadtimes}.png"
        fig.savefig(figname, dpi=100)
        ...
        ax.grid(True)
        figname = f"{args.output_dir}/scree_plot_kaiser_w_scatter_{args.case}_{leadtimes}.png"
        fig.savefig(figname, dpi=100)
        ...
        for id, evals in enumerate([w_samples_sorted_eigenvalue, w_inv1_sorted_eigenvalue, w_inv2_sorted_eigenvalue]):
        ...
        ax.grid(True)
        figname = f"{args.output_dir}/profile_log_likelihood_w_scatter_{args.case}_{leadtimes}.png"
        fig.savefig(figname, dpi=100)
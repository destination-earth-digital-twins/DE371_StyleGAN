...
parser.add_argument('--output_dir',      type=str, default='/scratch/mrmn/sanchezv/project/results/Latent_Space_Analysis/results_pca')
parser.add_argument('--w_inversion_dir1', type=str, default='/scratch/mrmn/sanchezv/project/results/Inversion_Exp/Ens_Perceptual_Random_VGG_Loss_sol2/Inversion_Perceptual_Random_VGG_Loss_sol2')
parser.add_argument('--w_inversion_dir2', type=str, default='/scratch/mrmn/sanchezv/project/results/Inversion_Exp/Ens_MSE_Loss/Inversion_MSE_Loss') 
parser.add_argument('--w_samples_dir',   type=str, default='/scratch/mrmn/sanchezv/project/results/Latent_Space_Analysis/results_pca/w_samples') # samples generated with mkl_w_sample.py
parser.add_argument('--inversion_step',  type=str, default="2000")
parser.add_argument('--case',           type=str, default="2021-08-14_24", help="specific inversion case to consider") # %Y-%m-%d_lt
...
print(np.linalg.norm(w_inv1_projected-w_inv2_projected, axis=1))

...
parser.add_argument('--output_dir',      type=str, default='/project/scratch/p200177/DE_371/victorsanchez/results/pca/profile_log_likelihood')
parser.add_argument('--w_inversion_dir1', type=str, default='/project/scratch/p200177/DE_371/inversion_process_analysis/inversion/exp52/inversion')
...
parser.add_argument('--case',           type=str, default="2021-07-07_3", help="specific inversion case to consider") # %Y-%m-%d_lt
